...
function resizeChatTextarea(textarea: HTMLTextAreaElement | null): void {
  ...
  const viewportHeight = typeof window !== "undefined"
    ...
    : 400;
  const maxHeight = narrow ? Math.min(120, viewportHeight * 0.3) : 200;
...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput({
  ...
  useEffect(() => {
    ...
    const handleViewportResize = () => resizeChatTextarea(textareaRef.current);
  ...
  return (
    <div
      style={{
        ...
        padding: isMobile ? "0 8px 8px" : "0 16px 8px",
        ...
        <div style={{ position: "relative" }}>
          ...
          <div
            style={{
              ...
              borderRadius: 14,
              padding: isMobile ? "8px 8px 8px 10px" : "10px 10px 10px 14px",
          ...
          <textarea
            ...
            style={{
              ...
              fontFamily: "inherit",
              minHeight: 24,
              maxHeight: isMobile ? "min(120px, 30dvh)" : 200,
              overflowY: "auto",
              overflowX: "hidden",
            }}
          />
